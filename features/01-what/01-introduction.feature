Feature: Introducing Gherkin

  Gherkin is the language that Cucumber uses to define test cases. It is designed to be
  ...
  Scenario: Gherkin is an expression of system behavior
    ...
    Then is the keyword to express the expected outcome of the behavior
